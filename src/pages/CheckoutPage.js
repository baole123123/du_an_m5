                      ...
                      <tbody>
                        {cart.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td>${numeral(item.product.price).format("0,0")} VNĐ</td>
                          </tr>
                        ))}
                        <tr>
                          ...
                          <td className="text-black">
                            ${numeral(cartSubtotal.toFixed(2)).format("0,0")} VNĐ
                          </td>
                        </tr>
                        <tr>
                          <td className="text-black font-weight-bold">
                          ...
                          <td className="text-black font-weight-bold">
                            <strong>${numeral(cartSubtotal.toFixed(2)).format("0,0")} VNĐ</strong>
                          </td>
                        </tr>
                      </tbody>
                    </table>
